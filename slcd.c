...
void slcdInitialize(void){
	...
	PORTB->PCR[7] = PORT_PCR_MUX(0x01);
	PORTB->PCR[8] = PORT_PCR_MUX(0x01);
	PORTB->PCR[10] = PORT_PCR_MUX(0x01);
	PORTB->PCR[11] = PORT_PCR_MUX(0x01);
	PORTB->PCR[21] = PORT_PCR_MUX(0x01);
	PORTB->PCR[22] = PORT_PCR_MUX(0x01);
	PORTB->PCR[23] = PORT_PCR_MUX(0x01);
	PORTC->PCR[17] = PORT_PCR_MUX(0x01);
	PORTC->PCR[18] = PORT_PCR_MUX(0x01);
	PORTD->PCR[0] = PORT_PCR_MUX(0x01);
	PORTE->PCR[4] = PORT_PCR_MUX(0x01<<2);
	PORTE->PCR[5] = PORT_PCR_MUX(0x01<<2);
...
void slcdSet(uint8_t value, uint8_t digit){	
	...
	switch(value){
		...
		case 0x0A:
			...
			break;
		case 0x0B:
			LCD->WF8B[LCD_Front_Pin[((2*digit)-2)]] = (LCD_S_E | LCD_S_F | LCD_S_D | LCD_S_G);
